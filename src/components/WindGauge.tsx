...
function WindArrow({ degrees }: { degrees: string }) {
    return <i className={'fas fa-long-arrow-alt-down'} style={{ fontSize: "55px", color: arrowColor, transform: `rotate(${degrees}deg)` }} />
}
        ...
        <WindLabel>
            <div>
                <div>
                    ...
                    <br /><span style={updatedStyle}>{lastEntry.t}</span>
                </div>
